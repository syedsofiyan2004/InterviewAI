export const DEFAULT_SOW_PEER_REVIEW_SKILL = `---
...
export const SOW_REVIEW_JSON_CONTRACT = `Application output contract: Return only one complete JSON object with this exact shape:
...
Do not include Markdown fences or prose outside the JSON object. Completing valid JSON is more important than adding repetitive findings.`;
